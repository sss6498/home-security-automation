...
void loop() {
  if ((CAM1_EXIST && stopMotion)||(digitalRead(takePic)==HIGH)) {
...
void myCAMSendToSerial(ArduCAM myCAM) {     //Captures image and saves the bytes in a string that is sent to the serial
  char str[8];
  byte buf[5];
